...
{
  label: "Hostel",
  value: user.hostelName || "N/A", // Ensure this is JUST "BRAHMAPUTRA", not "BRAHMAPUTRA Hostel"
...
/>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            ...
            <motion.div 
              variants={itemVariants}
              className="p-5 md:p-6 bg-white border border-slate-100 rounded-[2rem] md:rounded-3xl shadow-sm relative overflow-hidden group min-h-[160px] flex flex-col justify-between"
            >
              <div>
            ...
            <motion.div
              variants={itemVariants}
              className="p-8 bg-indigo-600 rounded-[2.5rem] shadow-xl text-white shadow-indigo-200 hover:-translate-y-1 transition-all flex flex-col justify-between"
            >
              <div>
              ...
              <div className="mt-4 inline-block bg-white/20 backdrop-blur-md px-4 py-2 rounded-xl text-xs font-bold w-fit">
                {techVisit
