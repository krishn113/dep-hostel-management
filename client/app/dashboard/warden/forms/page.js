                      ...
                      >
                        <td className="p-6">
                          ...
                          <div className="text-xs text-slate-500 font-medium">
                            {form.applicantEntryNo ||
                              form.studentId?.entryNumber ||
                              "N/A"}
                          </div>
                        ...
                        <td className="p-6 text-sm">
                          ...
                          {form.paymentByGuest && (
                            <div className="text-[9px] font-black uppercase tracking-widest text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded-full inline-block mt-2">
                              Payment via Guest
                            </div>
                          )}
                        </td>
                        ...
                        <td className="p-6 text-sm text-slate-600">
                          <div className="font-bold text-slate-700">
                            {form.roomToBeBooked || form.roomType}
                          </div>
